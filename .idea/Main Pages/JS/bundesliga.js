...
let detailedteamInfo = {
    fetchdetailedteamInfo: function () {
        fetch(`https://v3.football.api-sports.io/standings?league=78&team=${id}&season=2022`, {
            "method": "GET",
            "headers": {
                "x-rapidapi-host": "v3.football.api-sports.io",
                "x-rapidapi-key": "aefedc74219709b46c5b8bcded1a0d04"
...
let teamStats = {
    fetchTeamStats: function () {
        fetch(`https://v3.football.api-sports.io/teams/statistics?league=78&team=${id}&season=2022`, {
            "method": "GET",
            "headers": {
                "x-rapidapi-host": "v3.football.api-sports.io",
                "x-rapidapi-key": "aefedc74219709b46c5b8bcded1a0d04"
